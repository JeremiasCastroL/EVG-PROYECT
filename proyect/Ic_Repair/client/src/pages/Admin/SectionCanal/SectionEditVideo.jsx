...
export function EditVideo() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await putVideo(parseInt(author), finalVideo);
    ...
    useEffect(() => {
        const fetchVideo = async () => {
            try {
                const res = getVideo.data;
                console.log(res)
                const videoFiltrado = res.find((v) => v.id === parseInt(author));
                if (videoFiltrado) {
                    setVideo(videoFiltrado);
                } else {
                ...
                <div className="w-[45%] bg-[#fff] px-[20px] mt-[30px] rounded-[10px] py-[30px]">
                    <form className="" onSubmit={handleSubmit}>
                        <div className="flex flex-col items-center">
                            ...
                            >
                                <img src={`http://localhost:3000/uploads/portadas/${video.image}`} alt="" className="w-[100%] h-[100%] object-cover" />
                        ...
                        <div className="flex flex-col gap-[10px] mt-[30px] items-center">
                            ...
                            <input
                                ...
                                name="video"
                                accept="video/*"
                                // value={`http://localhost:3000/uploads/videos/${video.video}`}
