    ...
    return (
        <section className="flex flex-col items-center">
             <div className="w-[30%] flex flex-col items-center pt-[30px]">
                ...
                <input type="text" placeholder="Email..." className="w-[100%] focus:border-[#999] focus:border-[2px] outline-none duration-100 h-[50px] px-[20px] mt-[20px] border-[1px] border-[#6669] rounded-[12px]"/>
                <button className="h-[47px] bg-[#0056B3] hover:bg-[#004494] duration-150 rounded-[12px] text-[#fff] text-[17px] font-[600] w-[100%] flex justify-center items-center mt-[10px]">Continuar</button>
                ...
                <Link className="flex justify-center items-center gap-[4px] mt-[37px]">
                    <p className="text-[#555] text-[15px]">¿No tienes cuenta?</p>
                    <Link className="underline text-[#333] text-[15px] font-[500]">Registrate</Link>
                </Link>
             </div>
