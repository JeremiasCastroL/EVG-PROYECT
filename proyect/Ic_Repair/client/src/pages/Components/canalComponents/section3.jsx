        ...
        <section className="relative mt-[100px]">
             <h3 className="font-[800] text-[45px] text-[#111] font-[Poppins]">Galería</h3>
                                  <div className="relative flex mt-[20px] flex-wrap justify-between">
                                    ...
                                    <Link to="/galeria" className="absolute left-[50%] rounded-[30px] translate-x-[-50%] bottom-[10px] px-[30px] py-[12px] font-[Poppins] hover:bg-[#f90] bg-[#f6b000] transition duration-300 ease-in-out font-[800] text-[#fff]">Ver Más</Link>
                                  ...
                                  <div className="fixed hidden bg-[#f5f5f5] w-[100vw] z-[900] items-center h-[100vh] top-[0px] left-[0px] justify-center">
                                        <img src="../../public/assets/imag5.jpg" alt="" className="h-[95%] relative w-[auto]"/>
                                        <Link className="hover:bg-[#f90] bg-[#f6b000] transition duration-300 ease-in-out rounded-[50%] absolute right-[60px] cursor-pointer top-[40px] w-[50px] h-[50px] flex justify-center items-center">
