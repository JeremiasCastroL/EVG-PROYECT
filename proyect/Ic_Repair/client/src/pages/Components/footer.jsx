...
export function FooterSection(){
    return (
        <footer className="bg-[#f5f5f5] px-[110px] pt-[40px]">
                                   <img src="../../../public/assets/LOGO DE EVG2.png" alt="" className="w-[120px] h-[120px]"/> 
                                   <div className="flex gap-[150px] mt-[25px]">
                                           <div className="flex flex-col gap-[10px]">
                                                <Link className="text-[#000] text-[17px] font-[Poppins]">Inicio</Link>
                                                <Link className="text-[#000] text-[17px] font-[Poppins]">Canal</Link>
                                                {/* <Link>Contacto</Link> */}
                                                <Link className="text-[#000] text-[17px] font-[Poppins]">Galería</Link>
                                          </div>
                                          <div className="flex flex-col gap-[10px]">
                                          ...
                                          <div className="flex flex-col gap-[10px]">
                                                <Link className="text-[#000] text-[17px] font-[Poppins]">Terminos</Link>
                                               <Link className="text-[#000] text-[17px] font-[Poppins]">Privacidad</Link>
                                          </div>
                                    </div> 
